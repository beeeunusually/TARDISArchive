...
PART.ID = "tardis2010_corridordoors4"
PART.Name = "2010 TARDIS Corridor Doors 4"
PART.Model = "models/doctorwho1200/copper/intdoors4.mdl"
PART.AutoSetup = true
