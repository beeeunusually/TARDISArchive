...
PART.ID = "tardis2010_corridordoors13"
PART.Name = "2010 TARDIS Corridor Doors 13"
PART.Model = "models/doctorwho1200/copper/intdoors13.mdl"
PART.AutoSetup = true
...
PART.SoundPos = Vector(265,581,145)
