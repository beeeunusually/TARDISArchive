...
PART.ID = "tardis2010_corridordoors11"
PART.Name = "2010 TARDIS Corridor Doors 11"
PART.Model = "models/doctorwho1200/copper/intdoors11.mdl"
PART.AutoSetup = true
...
PART.SoundPos = Vector(-478, 462, 145)
