...
PART.ID = "tardis2010_corridordoors5"
PART.Name = "2010 TARDIS Corridor Doors 5"
PART.Model = "models/doctorwho1200/copper/intdoors5.mdl"
PART.AutoSetup = true
...
PART.SoundPos = Vector(227,-766,-43)
