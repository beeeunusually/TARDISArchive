local PART={}
PART.ID = "hartnellbulbswitch2"
PART.Name = "1963 TARDIS Bulb Switch 2"
PART.Model = "models/doctorwho1200/hartnell/bulbswitch2.mdl"
PART.AutoSetup = true
...
if CLIENT then
	function PART:Think()
		...
		local switch = TARDIS:GetPart(self.interior,"hartnellswitch2")
		if power == true then
